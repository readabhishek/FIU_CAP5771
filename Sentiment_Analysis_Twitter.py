...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        tw_access_token = 'xxxxxxxxxxxxxxxxxxxxxxxx'
        tw_access_token_secret = 'yyyyyyyyyyyyyyyyyyyyyyyyy'
        tw_consumer_key = 'xxxxxxxxxxxxxxxxxxxxxxxxxx'
        tw_consumer_secret = 'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrr'
...
def display_sentiment_figures(tweets, title):
...
def main(filename, title, source=None):
    ...
    '''
    if (source=='I'):                                 # If called from outside/other-file then we don't pass source. This is to ensure we set the right path
        filename = './project_modules/'+ filename
        tempfile = './project_modules/temp_data.csv'
    else:
        tempfile = 'temp_data.csv'
    tweets = twitter_api.analyze_sentiments(filename, tempfile)
    display_sentiment_figures(tweets, title)
