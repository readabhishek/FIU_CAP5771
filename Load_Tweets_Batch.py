...
class Load_Tweets_Batch(object):
    ...
    def __init__(self):
        ...
        tw_access_token = 'wwwwwwwwwwwwwwwwwwwwwwww'
        tw_access_token_secret = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
        tw_consumer_key = 'ccccccccccccccccccccccccccccccccc'
        tw_consumer_secret = 'vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv'
...
def main(operation, query=None, filename=None, start_date=None, since_date=None, purge_date_from=None, purge_date_to=None):
    ...
    if (operation =='B'):
        ...
        purge_tweets(filename=filename, purge_date = purge_date_from, end_date = purge_date_to)
